    ...
    public class Estacionamento
    {
        ...
        public void RemoverVeiculo()
        {
            ...
            if (veiculos.Any(x => x.ToUpper() == placa.ToUpper()))
            {
                ...
                decimal calculo = precoInicial + precoPorHora * quantidadeHoras;
                ...
                Console.WriteLine($"O veículo {placa} foi removido e o preço total foi de: R$ {calculo}");
            }
            else
            {
